...
def lab4_sort_and_search():
    """Q4. Sorting and Searching of Student IDs"""
    print("\n--- Sorting and Searching IDs ---")
...
def lab7_directory_scanner():
    ...
    print("\n--- Directory Scanner ---")
    directory_path = input("Enter the directory path to scan (or '.' for current directory): ")
...
def main_dashboard():
    ...
    while True:
        ...
        print("6. File Manager - Academic Records ")
        print("7. Directory Scanner - Exception Handling")
        print("8. Performance Analytics - NumPy/Pandas/Plot")
        print("9. Exit System")
        print("="*50)
        ...
        if choice == '1':
            ...
            lab3_record_management()
        elif choice == '4':
            lab4_sort_and_search()
        elif choice == '5':
